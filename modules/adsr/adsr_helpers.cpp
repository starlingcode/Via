...
void ViaAdsr::render(int32_t writePosition) {
	...
	int32_t mainLogic = !releasing & !sustaining;
	int32_t assignableLogicOut = 2048 - *assignableLogic * 2048;
	int32_t auxLogic = sustaining;

	outputs.logicA[0] = GET_ALOGIC_MASK(mainLogic);
