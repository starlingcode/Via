...
void ViaMeta::fillWavetableArray(void) {
	...
	wavetableArray[1][4] = &wavetableSet.moving_lump;
	wavetableArray[1][5] = &wavetableSet.fixed_lump;
	...
	wavetableArray[2][2] = &wavetableSet.newest_bounce;
	wavetableArray[2][3] = &wavetableSet.rubberband;
	wavetableArray[2][4] = &wavetableSet.mountains;
	wavetableArray[2][5] = &wavetableSet.half_sines;
	wavetableArray[2][6] = &wavetableSet.block_test;
	wavetableArray[2][7] = &wavetableSet.newest_steps;
}
